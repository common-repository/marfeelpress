...
use Marfeel\Symfony\Component\Config\Util\XmlUtils;
...
use Marfeel\Symfony\Component\Config\Resource\FileResource;
...
class XliffFileLoader implements LoaderInterface
{
    ...
    public function load($resource, $locale, $domain = 'messages')
    {
        ...
        if (class_exists('Marfeel\Symfony\Component\Config\Resource\FileResource')) {
