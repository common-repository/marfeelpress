...
namespace Marfeel\Monolog\Handler;

use Exception;
use Marfeel\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \Marfeel\Monolog\Logger('all', array(new \Marfeel\Monolog\Handler\PHPConsoleHandler()));
 *      \Marfeel\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('Marfeel\Monolog\\'), // array Hide calls of classes started with...
    ...
    /**
     * @param  array          $options   See \Marfeel\Monolog\Handler\PHPConsoleHandler::$options for more details
