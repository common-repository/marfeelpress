...
use Marfeel\Symfony\Component\Config\Resource\BCResourceInterfaceChecker;
use Marfeel\Symfony\Component\Config\Resource\SelfCheckingResourceChecker;

/**
 * ConfigCache caches arbitrary content in files on disk.
 *
 * When in debug mode, those metadata resources that implement
 * \Marfeel\Symfony\Component\Config\Resource\SelfCheckingResourceInterface will
 * be used to check cache freshness.
 *
 * During a transition period, also instances of
 * \Marfeel\Symfony\Component\Config\Resource\ResourceInterface will be checked
