...
require_once dirname(__FILE__).'/../Marfeel_Marfeel_Mobile_Detect.php';
$detect = new Marfeel_Marfeel_Mobile_Detect;
...
$fileName = dirname(__FILE__).'/../Marfeel_Marfeel_Mobile_Detect.json';
